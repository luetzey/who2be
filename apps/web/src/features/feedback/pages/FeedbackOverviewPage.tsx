import { BarChart3, ChevronRight, ThumbsUp, TriangleAlert } from 'lucide-react'
...
export function FeedbackOverviewPage() {
  ...
  return (
    <Container>
      ...
      {/* Kurations-Uebersicht: aggregiertes Feedback pro Element. */}
      <section className="mt-10 flex flex-col gap-4">
        <div className="flex items-center gap-3">
          <EntityIcon icon={BarChart3} tone="catalog" size="sm" />
          <div>
            <h2 className="text-lg font-semibold tracking-tight">{t('overview.curationTitle')}</h2>
        ...
        <div className="flex flex-wrap items-center gap-3">
          ...
          <Button
            ...
            className={cn(
              'ml-auto',
              careOnly && 'border-destructive/40 bg-destructive/10 text-destructive hover:text-destructive',
            )}
          >
            <TriangleAlert />
            {t('overview.careOnly')}
