...
from who2be_models import ChunkType, ContentChunkHit, SearchHit, SearchType
...
def get_content_chunk_service(
    ...
    return ContentChunkService(PgContentChunkRepository(pool), pool)
...
async def search_content(
    ...
    """
    return await service.search(ctx, q, _parse_chunk_types(types), limit)
