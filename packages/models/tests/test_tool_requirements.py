...
def test_mapping_covers_all_registered_server_tools() -> None:
    # 83 `@with_tool_log("<name>")`-Registrierungen in apps/mcp: 58 in
    # server.py + 8 WorkArea-Tools aus `tools/workarea.py` + 6 KB-Tools aus
    # `tools/kb.py` inkl. `promote_artifact` + 11 Tabellen-/Timeline-Tools aus
    # `tools/tables.py` (WP8/WP9/WP19 — ADR-0047/0049). Die Welle-7-Zaehlung
    # plante 71 -> 81; die beiden zusaetzlichen sind `list_tables`/
    # `delete_table` (Befund 2026-08-17: Tabellen waren ueber MCP weder
    # auffindbar noch loeschbar).
