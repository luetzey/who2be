...
class ResourceCreate(BaseModel):
    ...
    locale: ContentLocale | None = Field(
        default=None,
        description=(
            "Sprache DIESER Resource — kein Antwort-/Rendering-Schalter, sondern "
            "ein Element-Attribut. Leer lassen: die Resource uebernimmt die "
...
class ResourceUpdate(BaseModel):
    ...
    locale: ContentLocale | None = Field(
        default=None,
        description=(
            "Sprachwechsel fuer DIESE Resource — kein Antwort-/Rendering-"
