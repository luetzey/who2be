...
class PlaybookCreate(BaseModel):
    ...
    locale: ContentLocale | None = Field(
        default=None,
        description=(
            "Sprache DIESES Playbooks — kein Antwort-/Rendering-Schalter, sondern "
            "ein Element-Attribut. Leer lassen: das Playbook uebernimmt die "
...
class PlaybookUpdate(BaseModel):
    ...
    locale: ContentLocale | None = Field(
        default=None,
        description=(
            "Sprachwechsel fuer DIESES Playbook — kein Antwort-/Rendering-"
