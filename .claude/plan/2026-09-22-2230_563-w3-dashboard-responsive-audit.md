...
| `components/PaginationControls.tsx` | **Defekt A:** `<nav>` ohne `flex-wrap` (Punkt 1). **Defekt B:** `size="sm"` = `h-9` (36 px) unterhalb `md` < 40 px (Punkt 4 / §11). | `flex-wrap` am `<nav>`; `h-10 md:h-9` an beiden Buttons |
