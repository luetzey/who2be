...
| `2026-07-09-1556_builder-agents-ui-improvements.md` | Builder-Befähigung (Placeholder/Modi/Sub-Playbooks) + Agent-Filter + UI-Polish (Git-Diff, Trigger-Pills, Playbooks-Liste, Persona-Sektion) — 6 WPs, Umsetzung offen |
