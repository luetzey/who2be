- Lange Bezeichner ohne Trennstellen brechen in den geteilten Listen- und
  ...
  Die H1 bekommt zusätzlich `min-w-0`: als Flex-Item hat sie `min-width: auto`
  und bliebe sonst auf der ungebrochenen Wortbreite stehen, bevor der Umbruch
  greifen kann. Weil die Änderung am geteilten Primitive sitzt, wirkt sie in allen dreizehn
